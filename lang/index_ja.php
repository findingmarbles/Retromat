...
$_lang['INDEX_ABOUT'] = 'Retromatは現在、<span class="js_footer_no_of_activities"></span>のアクティビティがあり、<span class="js_footer_no_of_combinations"></span>通り(<span class="js_footer_no_of_combinations_formula"></span>)の組み合わせがあります。アクティビティは定期的に追加されます。';
