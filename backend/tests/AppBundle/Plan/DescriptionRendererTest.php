...
class DescriptionRendererTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRender()
    {
        ...
        $activity1->setRetromatId(4)->setSummary('Participants write down significant events and order them chronologically');
        $activities[1] = $activity1;

        $activity2 = new Activity2();
        $activity2->setRetromatId(8)->setSummary('Drill down to the root cause of problems by repeatedly asking \'Why?\'');
