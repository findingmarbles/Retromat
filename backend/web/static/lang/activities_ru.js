...
название: "безумный грустный рад",
резюме: "Собери событиях, когда члены команды чувствовали ума, грустить, или радоваться и находить источники",
описание: "выставил три плаката с надписью 'безумный', 'грустный' и 'рад' (или '>:), :(, :) в качестве альтернативы). Члены команды записать \
одно событие за цветом карты, когда они считали, что путь. Когда время истекло \
все выкладывают свои карты в соответствующие плакаты. Кластер карты на \
каждый плакат. Попросите группу для кластера имена. в <br>\
Допрос, спрашивая:\
<ул>\
<литий>, что стоишь? Что-то неожиданное?</литий>\
 <литий>, что было сложного в этой задаче? Что понравилось?</литий>\
<ли>какие узоры вы видите? Что это означает для вас как команда?</литий>\
<литий>предложения о том, как продолжить?</литий>\
</ул>",
источник: source_agileRetrospectives,
durationDetail: "15-25",
Продолжительность: "средний",
этап: "все",
подходит: "итерации, релиза, проект, интроверты"
